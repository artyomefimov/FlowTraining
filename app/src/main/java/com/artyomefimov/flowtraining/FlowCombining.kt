...
class FlowCombining {
     ...
     */
    fun summation(flow1: Flow<Int>, flow2: Flow<Int>) = flow {
     ...
     */
    fun requestItems(searchFlow: Flow<String>, categoryFlow: Flow<Int>) = flow {
    ...
    fun composition(flow1: Flow<Int>, flow2: Flow<Int>) = flow {
     ...
     */
    fun additionalFirstItem(intFlow: Flow<Int>, firstItem: Int) = flow {
